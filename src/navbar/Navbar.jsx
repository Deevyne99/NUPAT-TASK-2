    ...
    <header className=' py-8 bg-[#fff] '>
      <div className='flex flex-col mx-12'>
        <div className='flex justify-between items-center'>
          <article>
            <h2 className='text-3xl font-bold'>New Campaign Run </h2>
            <p className='text-grayColor text-sm mt-1'>
              A new campaign launch work for brand new featur in May month
            </p>
          </article>
          <div>
            <button className=' text-center rounded-md  bg-[#000] text-[#fff] text-sm p-2 w-[150px] uppercase'>
              add members
            </button>
          </div>
        </div>
        <div className='flex justify-between mt-16'>
          <div className='flex  gap-2 items-center'>
            ...
            <p className='text-grayColor'>8 member</p>
          </div>
          <ul className='flex gap-4 text-[#7D8088]'>
